<?php
	...
	if (isset($_GET['id'])){
		...
		$query=mysqli_query($conn, "select * from detalle_factura where id_producto='".$id_producto."'");
		$count=mysqli_num_rows($query);
		if ($count==0){
			if ($delete1=mysqli_query($conn,"DELETE FROM products WHERE id_producto='".$id_producto."'")){
			?>
