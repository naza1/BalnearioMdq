<?php
	...
	if (isset($_GET['tipo_contrato'])){
		...
		$query=mysqli_query($con, "select * from tipos_contrato where tipo_contrato='".$tipo_contrato."'");
		$count=mysqli_num_rows($query);
		if ($count==0){
			if ($delete1=mysqli_query($con,"DELETE FROM tipos_contrato WHERE tipo_contrato='".$tipo_contrato."'")){
			?>
