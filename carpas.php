  ...
  <body>
	...
	<div class="panel panel-success">
		...
		<div class="panel-body">
			...
			include("modal/editar_carpa_estado.php");
			?>
				...
				<div class="row">
					...
					<div class='col-md-4'>
						...
						<select class='form-control' name='id_pasillo' id='id_pasillo' onchange="load(1);">
							...
							<?php 
							$query_pasillo=mysqli_query($con,"select * from pasillos order by id_pasillo");
							while($rw=mysqli_fetch_array($query_pasillo))	{
								?>
							<option value="<?php echo $rw['id_pasillo'];?>"><?php echo $rw['id_pasillo'];?></option>			
								<?php
							}
							?>
						</select>
					...
					<div class='col-md-4'>
						<label>CONTEO EN EL BALNEARIO</label>
