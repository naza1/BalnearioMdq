	...
	<div class="panel panel-success">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#nuevaCarpa"><span class="glyphicon glyphicon-plus" ></span> Agregar Sombrilla</button>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> SOMBRILLAS</h4>
		</div>
